...
# Examples
```julia-repl
julia> DualOptimalFiltering_proof.prod_2_gammas_arb(1, 1, 1, 1) #== 0.5
...
julia> DualOptimalFiltering_proof.prod_2_gammas_arb(2, 0.5, 1, 0.5) #==  log(0.5^2*0.5 )
...
# Examples
```julia-repl
julia> DualOptimalFiltering_proof.int_prod_2_Dir_arb([1,1], [1,1])
1.
julia> DualOptimalFiltering_proof.int_prod_2_Dir_arb(2, 0.5, 1, 0.5) #==  0.5^2*0.5
1.125
```
"""
