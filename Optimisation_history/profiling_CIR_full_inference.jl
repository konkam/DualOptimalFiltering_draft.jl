...
import DualOptimalFiltering_proof.sample_1_trajectory_from_joint_smoothing_CIR, DualOptimalFiltering_proof.draw_next_sample, DualOptimalFiltering_proof.joint_loglikelihood_CIR, DualOptimalFiltering_proof.hidden_signal_loglikelihood_CIR, DualOptimalFiltering_proof.keep_fixed_number_of_weights, DualOptimalFiltering_proof.normalise, DualOptimalFiltering_proof.sample_1_trajectory_from_joint_smoothing_CIR_precompute, DualOptimalFiltering_proof.inverse_reparam_CIR, DualOptimalFiltering_proof.prune_all_dicts, DualOptimalFiltering_proof.reparam_joint_loglikelihood_CIR
...
@time Λ_of_t, wms_of_t, θ_of_t = DualOptimalFiltering_proof.filter_CIR_pruning(θ_it_δγ_param[1], θ_it_δγ_param[2], θ_it_δγ_param[3], λ, data, do_the_pruning, silence = true)
...
@profview parameter_chain, trajectory_chain = DualOptimalFiltering_proof.joint_sampler_CIR_reparam_keep_fixed_number_precompute(data_CIR, λ, prior_logpdf, 30, 10; final_chain_length = 1000, silence = false, jump_sizes = (.5, .5, 0.25))
