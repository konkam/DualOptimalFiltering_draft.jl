...
@testset "test exact L2 distance functions for Dirichlet mixtures" begin
    ...
    log_ν_dict_arb, log_Cmmi_dict_arb, log_binomial_coeff_dict_arb = DualOptimalFiltering.precompute_log_terms_arb(data__WF3, sum(α_vec); digits_after_comma_for_time_precision = 4)


    Λ_of_t_arb, wms_of_t_arb = DualOptimalFiltering.filter_WF_precomputed(α_vec, data__WF3, log_ν_dict_arb, log_Cmmi_dict_arb, log_binomial_coeff_dict_arb)
